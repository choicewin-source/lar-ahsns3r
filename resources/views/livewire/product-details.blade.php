            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-2xl border border-gray-100 p-6 relative">
                    ...
                    <div class="flex justify-between items-start mb-4">
                        ...
                        <div class="text-left">
                            <p class="text-4xl font-black text-red-600">{{ floatval($product->price) }} <span class="text-sm text-gray-500">₪</span></p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-green-50 p-4 rounded-xl border border-green-100">
                            ...
                            @if($product->contact_phone)
                                <a href="https://wa.me/{{ $product->contact_phone }}?text=مرحبا، شفت منتج {{ $product->name }} على موقع أحسن سعر.." target="_blank" 
                            ...
                            <a href="{{ route('products.show', $sim->id) }}" class="flex items-center gap-3 p-3 rounded-xl border border-gray-50 hover:bg-gray-50 hover:border-gray-200 transition group">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="flex justify-between items-center mt-1">
                                        ...
                                        <span class="text-sm font-black text-red-600">{{ floatval($sim->price) }}₪</span>
                                    </div>
                                </div>
                            </a>
                        @empty
